...
const tips: Tip[] = [
  {
    ...
    image: "/Rectangle 21908.png",
    href: "#",
  },
  {
    id: 2,
    title: "Set goals: Define monthly savings targets for success",
    excerpt: "Break your income into clear savings portions each month.",
    image: "/Rectangle 21908.png",
    href: "#",
  },
  {
    id: 3,
    title: "Avoid impulse: Delay purchases to prevent unnecessary spending",
    excerpt: "Wait before buying to ensure it is truly needed.",
    image: "/Rectangle 21908(2).png",
    href: "#",
  },
];
  ...
  return (
    <div ref={ref} className="tip-card">
      <div className="tip-img-wrap">
        <img src={tip.image} alt={tip.title} className="tip-img object-contain w-full h-64" />
      </div>
